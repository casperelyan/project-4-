...
In the next step of development, new functionality will be added to the page that allows users to add their own brutalist architecture with a photo and details such as coordinates, address, architect names, and date of construction. These details will be used to create a public database of brutalist architecture in each European country. Users will be able to download a pdf guide file and print it or use it as a trip planner 
...
As the project mainly includes black and white photos, the orange color was chosen as a strong contrast to gray. Matching color palette was generated by using [Canva website](https://www.canva.com/colors/color-palettes/mountains-at-dusk/). In addition to orange, dark blue and smoke white were also used as the fill colors for most text blocks.
